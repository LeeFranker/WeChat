...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private volatile int state = PULL_TO_REFRESH;
	...
	public void setLastUpdatedLabel(CharSequence label) {
		if (null != headerLayout) {
			headerLayout.setSubHeaderText(label);
		}
		if (null != footerLayout) {
			footerLayout.setSubHeaderText(label);
		}
	}
	...
	/**
	 * MODE_PULL_DOWN_TO_REFRESH = 0x1; // 上拉刷新 public static final int
	 * MODE_PULL_UP_TO_REFRESH = 0x2; public static final int MODE_BOTH = 0x3;
	 * 
	 * @param i
	 */
