...
public class RectImageView extends ImageView {
	...
	public RectImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RectImageView, defStyle, 0);

		mBorderWidth = a.getDimensionPixelSize(R.styleable.RectImageView_border_width, DEFAULT_BORDER_WIDTH);
		mBorderColor = a.getColor(R.styleable.RectImageView_border_color, DEFAULT_BORDER_COLOR);
